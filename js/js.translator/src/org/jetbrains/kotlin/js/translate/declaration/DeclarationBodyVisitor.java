...
public class DeclarationBodyVisitor extends TranslatorVisitor<Void> {
    ...
    public Void visitNamedFunction(@NotNull KtNamedFunction expression, TranslationContext context) {
        ...
        JsExpression prototypeRef = JsAstUtils.prototypeOf(referenceToCurrentClass(context));
    ...
    public Void visitProperty(@NotNull KtProperty expression, TranslationContext context) {
        ...
        PropertyTranslatorKt.translateAccessors(propertyDescriptor, expression, literal.getPropertyInitializers(), context);

        PropertyTranslatorKt.addAccessorsToPrototype(containingClass, propertyDescriptor, literal, context);
        return null;
    }
    ...
    @NotNull
    private JsNameRef referenceToCurrentClass(@NotNull TranslationContext context) {
        return JsAstUtils.pureFqn(context.getInnerNameForDescriptor(containingClass), null);
    }
}
