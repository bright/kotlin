...
import org.jetbrains.kotlin.resolve.getSinceVersionIfInaccessible
...
object ApiVersionCallChecker : CallChecker {
    ...
    private fun check(targetDescriptor: CallableDescriptor, context: CallCheckerContext, element: PsiElement) {
        ...
        val version = targetDescriptor.getSinceVersionIfInaccessible(context.languageVersionSettings)
        ...
        else if (targetDescriptor is PropertyDescriptor && DeprecatedCallChecker.shouldCheckPropertyGetter(element)) {
