...
public class BasicExpressionTypingVisitor extends ExpressionTypingVisitor {
    ...
    private static boolean isAnnotatedExpressionInBlockLevelBinary(KtAnnotatedExpression annotatedExpression) {
        ...
        return isBlockLevelExpression(parent);
    }

    private static boolean isBlockLevelExpression(@Nullable PsiElement expression) {
        return expression instanceof KtBlockExpression ||
               expression instanceof KtContainerNodeForControlStructureBody ||
               expression instanceof KtWhenEntry;
    }
